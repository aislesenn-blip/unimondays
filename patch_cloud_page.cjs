...
// Replace the old input with the dropzone
const oldInputRegex = /<Label>Bulk Exams PDF \(Max 2GB\)<\/Label>[\s\S]*?(?=<Separator \/>)/;
content = content.replace(oldInputRegex, dropzoneHTML);

fs.writeFileSync(targetPath, content);
console.log("Patched cloud page successfully");
