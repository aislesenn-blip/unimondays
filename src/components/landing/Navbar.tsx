  ...
  return (
    <nav className={cn("fixed top-0 left-0 right-0 z-50 h-20 border-b bg-background/80 backdrop-blur-md px-6 md:px-12 flex items-center justify-between", className)}>
      <div className="flex items-center gap-8">
        <Link href="/" className="text-2xl font-bold tracking-tight text-foreground flex flex-col leading-none">
          <span>Playbook.</span>
          <span className="text-[10px] font-normal text-muted-foreground tracking-widest">BY UNI MONDAY</span>
        </Link>
