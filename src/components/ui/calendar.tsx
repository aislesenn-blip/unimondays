  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: "space-x-1 flex items-center justify-between absolute w-full px-1 z-10",
        button_previous: cn(
        ...
        day_button: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 cursor-pointer hover:bg-blue-100 hover:text-blue-900"
        ),
        ...
        nav_button: cn(buttonVariants({ variant: "outline" }), "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 cursor-pointer"),
        ...
        day_selected: "bg-blue-600 text-white hover:bg-blue-600 hover:text-white focus:bg-blue-600 focus:text-white rounded-full shadow-md",
