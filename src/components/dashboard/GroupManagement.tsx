...
import { Users, Shuffle, Plus, Clock, MoreVertical, Trash2 } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-start">
        ...
        <Button>
          <Plus className="mr-2 h-4 w-4" /> New Group Set
        </Button>
      </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="pt-4">
              <Button className="w-full" variant="secondary">
                <Shuffle className="mr-2 h-4 w-4" /> Generate Groups
              </Button>
            </div>
          </CardContent>
        </Card>
          ...
          {previousSets.map((set) => (
            <div key={set.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50 transition-colors">
              ...
              <div className="flex gap-2">
                <Button variant="outline" size="sm" className="h-7 text-xs">Reuse</Button>
